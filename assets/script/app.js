...
var destC = "";  
var destS = "";  
var tFrequency; //val from the trainFreq input
var firstTime ;  // val from trainStart input
var firstTimeConverted;  // start time value converted
var currentTime = moment();  // Current Time
var diffTime;  // Difference between the times
var tRemainder;  // Time apart (remainder)
var tMinutesTillTrain;  // Minute Until Train
...
$('#trainStart').on('change', function(){
    firstTime = $(this).val();
	firstTimeConverted = moment(firstTime).subtract(1, "years");
    diffTime = firstTimeConverted.toNow("minutes");
});
$('#trainFreq').on('change', function(){
    tFrequency = parseInt($(this).val());
